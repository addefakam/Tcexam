...
<div class="body">
    ...
    <div style="margin-bottom: 40px; position: relative; z-index: 100;">
        <h3 style="color: #475569; margin-bottom: 20px;">Quick Actions</h3>
        <div style="display: flex; gap: 16px; flex-wrap: wrap;">
            <a href="tce_ai_importer.php" style="text-decoration: none; background: #4f46e5; color: white; padding: 16px 24px; border-radius: 12px; font-weight: 600; display: flex; align-items: center; gap: 12px; box-shadow: 0 4px 6px -1px rgba(79, 70, 229, 0.2); transition: all 0.3s ease; position: relative; z-index: 101;" class="quick-action-btn">
