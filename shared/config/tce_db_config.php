 ...
 */
define('K_DATABASE_TYPE', getenv('DATABASE_TYPE') ?: 'MYSQL');

/**
 * database Host name (eg: localhost)
 */
define('K_DATABASE_HOST', getenv('DATABASE_HOST') ?: 'localhost');
 ...
 */
define('K_DATABASE_PORT', getenv('DATABASE_PORT') ?: '3306');

/**
 * database name (TCExam)
 */
define('K_DATABASE_NAME', getenv('DATABASE_NAME') ?: 'tcexam');

/**
 * database user name
 */
define('K_DATABASE_USER_NAME', getenv('DATABASE_USER') ?: 'root');

/**
 * database user password
 */
define('K_DATABASE_USER_PASSWORD', getenv('DATABASE_PASSWORD') ?: 'root');
